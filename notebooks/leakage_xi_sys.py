...
params_upd = args.read_param_script(
    "params_xi_sys.py", obj_scale._params, verbose=True
)
...
alpha_0_r = 0.5 * (
    obj_scale.get_alpha_ufloat(0, 0) + obj_scale.get_alpha_ufloat(1, 1)
)
alpha_0_i = 0.5 * (
    -obj_scale.get_alpha_ufloat(0, 1) + obj_scale.get_alpha_ufloat(1, 0)
)
alpha_4_r = 0.5 * (
    obj_scale.get_alpha_ufloat(0, 0) - obj_scale.get_alpha_ufloat(1, 1)
)
...
# Using a_ij matrix
xi_sys_term_m_11 = (
    obj_scale.get_alpha_ufloat(0, 0) ** 2
    + obj_scale.get_alpha_ufloat(1, 0) ** 2
) * get_rho_0(obj_scale, 0, 0)
xi_sys_term_m_22 = (
    obj_scale.get_alpha_ufloat(0, 1) ** 2
    + obj_scale.get_alpha_ufloat(1, 1) ** 2
